...
from models.pointnet2_utils_sg3 import PointNetSetAbstractionMsg,PointNetSetAbstraction,PointNetFeaturePropagation
...
class get_model(nn.Module):
    ...
    def forward(self, xyz, cls_label):
        ...
        if self.normal_channel:
            ...
            l0_points = xyz
            l0_xyz = xyz
        l1_xyz, l1_points,l1_color,l1_colors = self.sa1(l0_xyz, l0_points,l0_color,l0_color)
